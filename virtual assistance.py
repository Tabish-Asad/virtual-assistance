...
def wishMe():
    ...
    if (hour>=0 and hour<12):
        speak("Good Morning TABISH  ASAD!")     #Text to Speech
    elif(hour>=12 and hour<18):
        speak("Good Afternoon TABISH ASAD")
    else:
        speak("Good Evening TABISH ASAD")
...
if 1:
    ...
    if 'wikipedia' in query:   #wikipedia is a keyword. If user doesnt say that, it will not work.
        ...
        music_dir= 'D:\song' #\\ slash is to escape the character
